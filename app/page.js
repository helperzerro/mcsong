...
export default function Home() {
  ...
  return (
    <div className="items-center flex justify-center py-4">
      <table className="w-[300px] border-separate border border-slate-500  bg-gray-700 text-white">
        <thead className="bg-gray-800">
          <tr className="border border-white ">
            <th className="border border-white">No</th>
            <th className="border border-white">Singer</th>
            <th className="border border-white">Title</th>
          </tr>
        </thead>
          ...
          {Object.values(lirikData).map((item, index) => (
            <tr key={index} className="text-center">
              ...
              <td className="border border-white">
                <Link
                  className="hover:scale-100 hover:font-bold transition"
